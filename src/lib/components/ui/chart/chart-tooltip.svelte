<script lang="ts">
	...
	function defaultFormatter(value: unknown, payload: TooltipPayload[]): string {
		void payload; // Parameter required by interface but not used in default implementation
		return `${value}`;
	}
